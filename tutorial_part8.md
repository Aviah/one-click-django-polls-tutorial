...
3. Created a working django applicatio
...
It's a great book, that covers many topics. This is not a step by step or in-depth text, but rather a collection of hints, tips and best practices about how to make a better django project.    
...
The book covers the core django's architecture, so it's absolutly insightful and relevant. Gives a good insight to the "zen" of django, and the fundemental design decisions of the framework.    
A really useful companion book from the same author: Pro Python.    
...
Django in Depth is a 3.5 hours long video by James Bernett at PyCon 2015.    
[Django in Depth Video](https://www.youtube.com/watch?v=tkwZ1jG3XgA)
